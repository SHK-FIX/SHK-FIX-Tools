const CACHE='shkfix-aufmass-v8';
const ASSETS=['./','./index.html','./styles.css','./app.js','./module-v2.js','./workflow-v4.js','./pdf-unicode.js','./photo-store.js','./photo-ui.js','./pdf-photos.js','./manifest.json'];
