const CACHE='shkfix-aufmass-v7';
const ASSETS=['./','./index.html','./styles.css','./app.js','./module-v2.js','./pdf-unicode.js','./photo-store.js','./photo-ui.js','./pdf-photos.js','./manifest.json'];
